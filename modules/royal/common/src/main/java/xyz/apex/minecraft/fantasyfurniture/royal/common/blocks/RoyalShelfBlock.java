...
public final class RoyalShelfBlock extends RoyalDyeableBlock
{
    private static final VoxelShapeCacher SHAPE_CACHE = new VoxelShapeCacher(blockState -> FantasyFurniture.getCorrectedShape(blockState, switch(blockState.getValue(ModBlockStateProperties.SHELF_TYPE)) {
        case LEFT -> RoyalVoxelShapes.SHELF_LEFT;
        case RIGHT -> RoyalVoxelShapes.SHELF_RIGHT;
        case SINGLE -> RoyalVoxelShapes.SHELF_SINGLE;
        case CENTER -> RoyalVoxelShapes.SHELF_CENTER;
    }));

    public RoyalShelfBlock(Consumer<Registrar> registrarConsumer, Properties properties)
    {
