...
public class RoyalCeilingLightBlock extends BaseBlockComponentHolder
{
    private static final VoxelShapeCacher SHAPE_CACHE = new VoxelShapeCacher(blockState -> FantasyFurniture.getCorrectedShape(blockState, RoyalVoxelShapes.CEILING_LIGHT));

    public RoyalCeilingLightBlock(Consumer<Registrar> registrarConsumer, Properties properties)
    {
