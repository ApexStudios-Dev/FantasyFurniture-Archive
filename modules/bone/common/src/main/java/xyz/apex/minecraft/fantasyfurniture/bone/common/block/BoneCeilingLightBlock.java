...
public class BoneCeilingLightBlock extends BaseBlockComponentHolder
{
    private static final VoxelShapeCacher SHAPE_CACHE = new VoxelShapeCacher(blockState -> FantasyFurniture.getCorrectedShape(blockState, BoneVoxelShapes.CEILING_LIGHT));

    public BoneCeilingLightBlock(Consumer<Registrar> registrarConsumer, Properties properties)
    {
