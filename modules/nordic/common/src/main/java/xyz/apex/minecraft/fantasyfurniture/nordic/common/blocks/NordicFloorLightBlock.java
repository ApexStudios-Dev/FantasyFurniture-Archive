...
public class NordicFloorLightBlock extends BaseBlockComponentHolder
{
    private static final VoxelShapeCacher SHAPE_CACHE = new VoxelShapeCacher(blockState -> FantasyFurniture.getCorrectedShape(blockState, NordicVoxelShapes.FLOOR_LIGHT));

    public NordicFloorLightBlock(Consumer<Registrar> registrarConsumer, Properties properties)
    {
