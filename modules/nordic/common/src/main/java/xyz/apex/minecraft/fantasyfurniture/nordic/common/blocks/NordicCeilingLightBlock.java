...
public class NordicCeilingLightBlock extends BaseBlockComponentHolder
{
    private static final VoxelShapeCacher SHAPE_CACHE = new VoxelShapeCacher(blockState -> FantasyFurniture.getCorrectedShape(blockState, NordicVoxelShapes.CEILING_LIGHT));

    public NordicCeilingLightBlock(Consumer<Registrar> registrarConsumer, Properties properties)
    {
