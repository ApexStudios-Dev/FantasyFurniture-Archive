...
public final class NordicSofaBlock extends BaseBlockComponentHolder
{
    private static final VoxelShapeCacher SHAPE_CACHE = new VoxelShapeCacher(blockState -> FantasyFurniture.getCorrectedShape(blockState, switch(blockState.getValue(ModBlockStateProperties.SOFA_TYPE)) {
        case LEFT -> NordicVoxelShapes.SOFA_LEFT;
        case RIGHT -> NordicVoxelShapes.SOFA_RIGHT;
        case SINGLE -> NordicVoxelShapes.SOFA_SINGLE;
        case CENTER -> NordicVoxelShapes.SOFA_CENTER;
        case CORNER -> NordicVoxelShapes.SOFA_CORNER;
    }));

    public NordicSofaBlock(Consumer<Registrar> registrarConsumer, Properties properties)
    {
