...
final class BlockBenchConverter extends BlockBenchProvider
{
    ...
    protected void convertModels()
    {
        ...
        convertDesk(null, "left", false).renderType(renderTypeCutout);
        convertDesk(null, "right", false).renderType(renderTypeCutout);
        ...
        Arrays.stream(ShelfType.values()).forEach(shelfType -> convertShelf(null, shelfType, false).renderType(renderTypeCutout));
