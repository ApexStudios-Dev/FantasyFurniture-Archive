...
public interface FurnitureSets
{
    ...
    static <R extends AbstractRegistrar<R>, B extends Block> BlockBuilder<R, B, R> dresser(R registrar, BlockFactory<B> blockFactory)
    {
        return registrar
                .object("dresser")
                .block(blockFactory)
    ...
    static <R extends AbstractRegistrar<R>, B extends Block> BlockBuilder<R, B, R> wardrobeBottom(R registrar, BlockFactory<B> blockFactory)
    {
        return registrar
    ...
    static <R extends AbstractRegistrar<R>, B extends Block> BlockBuilder<R, B, R> wardrobeTop(R registrar, BlockFactory<B> blockFactory)
    {
        return registrar
                .object("wardrobe_top")
                .block(blockFactory)
