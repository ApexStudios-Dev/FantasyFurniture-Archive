...
public interface NordicFurnitureSet
{
    ...
    BlockEntry<NordicPaintingSmallBlock> PAINTING_SMALL = FurnitureSets.paintingSmall(REGISTRAR, WOOD_TYPE, NordicPaintingSmallBlock::new).lang("en_us", "Small Nordic Painting").recipe(NordicFurnitureSet::nordicFurnitureStationRecipe).register();
    BlockEntry<NordicPaintingWideBlock> PAINTING_WIDE = FurnitureSets.paintingWide(REGISTRAR, WOOD_TYPE, NordicPaintingWideBlock::new).lang("en_us", "Wide Nordic Painting").recipe(NordicFurnitureSet::nordicFurnitureStationRecipe).register();
    ...
    BlockEntry<NordicBedSingleBlock> BED_SINGLE = FurnitureSets.bedSingle(REGISTRAR, WOOD_TYPE, NordicBedSingleBlock::new).lang("en_us", "Nordic Single Bed").recipe(NordicFurnitureSet::nordicFurnitureStationRecipe).register();
    BlockEntry<NordicBedDoubleBlock> BED_DOUBLE = FurnitureSets.bedDouble(REGISTRAR, WOOD_TYPE, NordicBedDoubleBlock::new).lang("en_us", "Nordic Double Bed").recipe(NordicFurnitureSet::nordicFurnitureStationRecipe).register();
    BlockEntry<NordicDoorSingleBlock> DOOR_SINGLE = FurnitureSets.doorSingle(REGISTRAR, WOOD_TYPE, NordicDoorSingleBlock::new).lang("en_us", "Nordic Single Door").recipe(NordicFurnitureSet::nordicFurnitureStationRecipe).register();
    BlockEntry<NordicDoorDoubleBlock> DOOR_DOUBLE = FurnitureSets.doorDouble(REGISTRAR, WOOD_TYPE, NordicDoorDoubleBlock::new).lang("en_us", "Nordic Double Door").recipe(NordicFurnitureSet::nordicFurnitureStationRecipe).register();
