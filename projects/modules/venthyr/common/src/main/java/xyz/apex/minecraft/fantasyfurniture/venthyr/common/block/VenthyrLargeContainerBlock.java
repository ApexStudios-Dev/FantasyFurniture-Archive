...
public class VenthyrLargeContainerBlock extends BaseBlockComponentHolder
{
    public VenthyrLargeContainerBlock(Properties properties)
    {
        super(properties);
    }
    ...
    {
        return VenthyrFurnitureSet.LARGE_CONTAINER_BLOCK_ENTITY.value();
    }
