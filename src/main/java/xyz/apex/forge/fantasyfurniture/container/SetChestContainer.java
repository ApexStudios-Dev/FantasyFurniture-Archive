...
public final class SetChestContainer extends BaseMenu
{
	public static final int ROWS = 6;
	public static final int COLS = 9;
	public static final int SIZE = ROWS * COLS;

	public SetChestContainer(@Nullable MenuType<? extends SetChestContainer> menuType, int windowId, Inventory playerInventory, FriendlyByteBuf buffer)
	{
