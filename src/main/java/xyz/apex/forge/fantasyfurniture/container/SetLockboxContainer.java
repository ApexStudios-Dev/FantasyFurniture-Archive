...
public final class SetLockboxContainer extends BaseMenu
{
	public static final int ROWS = 3;
	public static final int COLS = 5;
	public static final int SIZE = ROWS * COLS;

	public SetLockboxContainer(@Nullable MenuType<? extends SetLockboxContainer> menuType, int windowId, Inventory playerInventory, FriendlyByteBuf buffer)
	{
