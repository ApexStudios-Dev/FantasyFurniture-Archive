...
public final class FurnitureStation
{
	...
	{
		return new TranslatableComponent(DataGenerators.TXT_ACCEPTS_ANY, new TextComponent(tag.location().toString()).withStyle(ChatFormatting.ITALIC)).withStyle(ChatFormatting.GRAY);
	}
