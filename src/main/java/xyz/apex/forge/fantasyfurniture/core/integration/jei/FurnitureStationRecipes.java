...
public final class FurnitureStationRecipes
{
	...
	void draw(PoseStack pose, IDrawable background)
	{
		...
		font.drawShadow(pose, Component.translatable(DataGenerators.TXT_JEI_INGREDIENTS_KEY), 0F, 52F, -1);
		font.drawShadow(pose, Component.translatable(DataGenerators.TXT_JEI_RESULTS_KEY), 0F, 84F, -1);
	}
