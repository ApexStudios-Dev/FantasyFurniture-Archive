...
public interface AllItems
{
	...
	ItemEntry<BlockItem> FAIRY_LIGHTS_1 = ItemBuilders.blockItem(BlockItem::new, AllBlocks.FAIRY_LIGHTS_1)/*.tag(AllItemGroupCategories.DECORATIONS_TAG)*/.transform(ItemTransformers::applyDyeable).register();
	ItemEntry<BlockItem> FAIRY_LIGHTS_2 = ItemBuilders.blockItem(BlockItem::new, AllBlocks.FAIRY_LIGHTS_2)/*.tag(AllItemGroupCategories.DECORATIONS_TAG)*/.register();
	ItemEntry<BlockItem> PRESENTS_STACK_1 = ItemBuilders.blockItem(BlockItem::new, AllBlocks.PRESENTS_STACK_1)/*.tag(AllItemGroupCategories.DECORATIONS_TAG)*/.model((ctx, provider) -> ItemTransformers.stackedBlockItemModel(ctx, provider, PresentsStackBlock.PRESENTS)).register();
	ItemEntry<BlockItem> PRESENTS_STACK_2 = ItemBuilders.blockItem(BlockItem::new, AllBlocks.PRESENTS_STACK_2)/*.tag(AllItemGroupCategories.DECORATIONS_TAG)*/.transform(ItemTransformers::applyDyeable).model((ctx, provider) -> ItemTransformers.stackedBlockItemModel(ctx, provider, PresentsStackBlock.PRESENTS)).register();
	ItemEntry<BlockItem> SNOWBALLS = ItemBuilders.blockItem(BlockItem::new, AllBlocks.SNOWBALLS)/*.tag(AllItemGroupCategories.DECORATIONS_TAG)*/.model((ctx, provider) -> ItemTransformers.stackedBlockItemModel(ctx, provider, SnowballsBlock.SNOWBALLS)).register();
	ItemEntry<BlockItem> STOCKING = ItemBuilders.blockItem(BlockItem::new, AllBlocks.STOCKING)/*.tag(AllItemGroupCategories.DECORATIONS_TAG)*/.transform(ItemTransformers::applyDyeable).register();
	...
	ItemEntry<BlockItem> FURNITURE_STATION = ItemEntry.cast(AllBlocks.FURNITURE_STATION.getSibling(Registries.ITEM));
