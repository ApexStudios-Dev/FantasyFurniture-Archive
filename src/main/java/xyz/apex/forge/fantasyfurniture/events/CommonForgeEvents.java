...
public final class CommonForgeEvents
{
	...
	{
		var blockMappings = event.getMappings(ForgeRegistries.Keys.BLOCKS, Mods.FANTASY_FURNITURE);
		...
		var itemMappings = event.getMappings(ForgeRegistries.Keys.ITEMS, Mods.FANTASY_FURNITURE);
