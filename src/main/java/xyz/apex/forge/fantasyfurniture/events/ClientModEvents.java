...
public final class ClientModEvents
{
	...
	public static void onRegisterParticleProviders(ParticleFactoryRegisterEvent event)
	{
		...
		particleEngine.register(AllParticleTypes.SMALL_SOUL_FLAME.get(), FlameParticle.SmallFlameProvider::new);
		particleEngine.register(AllParticleTypes.NECROLORD_FLAME.get(), FlameParticle.Provider::new);
		particleEngine.register(AllParticleTypes.SMALL_NECROLORD_FLAME.get(), FlameParticle.SmallFlameProvider::new);
	}
}
