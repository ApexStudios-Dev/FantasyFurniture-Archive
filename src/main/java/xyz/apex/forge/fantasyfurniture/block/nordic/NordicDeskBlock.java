...
public final class NordicDeskBlock extends SetDeskBlock
{
	...
	public VoxelShape getShape(BlockState blockState, IBlockReader level, BlockPos pos, ISelectionContext ctx)
	{
		...
		VoxelShaper shaper = FurnitureSet.NORDIC.deskLeftBlock.is(this) ? pattern.isOrigin(blockState) ? SHAPER_LEFT_A : SHAPER_LEFT_B : pattern.isOrigin(blockState) ? SHAPER_RIGHT_A : SHAPER_RIGHT_B;
