...
public class BaseShelfBlock extends SimpleFourWayBlock
{
	...
	private static ConnectionType getConnectionState(IWorld level, BlockPos pos, BlockState blockState, BaseShelfBlock baseShelfBlock)
	{
	...
	private static boolean hasConnection(IWorld level, BlockPos pos, BaseShelfBlock baseShelfBlock)
	{
