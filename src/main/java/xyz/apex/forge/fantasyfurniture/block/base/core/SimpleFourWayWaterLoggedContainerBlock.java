...
public abstract class SimpleFourWayWaterLoggedContainerBlock<BLOCK_ENTITY extends InventoryBlockEntity<CONTAINER>, CONTAINER extends InventoryContainer> extends SimpleFourWayContainerBlock<BLOCK_ENTITY, CONTAINER> implements IWaterLoggable
{
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public SimpleFourWayWaterLoggedContainerBlock(Properties properties)
	{
		super(properties);
	}
