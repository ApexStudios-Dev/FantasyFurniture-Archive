...
public abstract class SimpleFourWayMultiBlockContainerBlock<BLOCK_ENTITY extends InventoryBlockEntity<CONTAINER>, CONTAINER extends InventoryContainer> extends SimpleFourWayMultiBlockEntityBlock<BLOCK_ENTITY>
{
	public SimpleFourWayMultiBlockContainerBlock(Properties properties, MultiBlockPattern pattern)
	{
	...
	public void setPlacedBy(World level, BlockPos pos, BlockState blockState, @Nullable LivingEntity placer, ItemStack stack)
	{
		...
		BLOCK_ENTITY blockEntity = getBlockEntity(level, pos, blockState);
	...
	{
		BlockPos blockEntityPos = getBlockEntityPos(blockState, pos);
