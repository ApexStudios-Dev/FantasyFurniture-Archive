...
public abstract class InventoryBlockEntity<CONTAINER extends Container> extends TileEntity implements INamedContainerProvider, INameableMutable, IContainerListener
{
	...
	private final FFContainers.ContainerFactory<CONTAINER> containerFactory;

	public InventoryBlockEntity(TileEntityType<? extends InventoryBlockEntity> blockEntityType, FFContainers.ContainerFactory<CONTAINER> containerFactory)
	{
