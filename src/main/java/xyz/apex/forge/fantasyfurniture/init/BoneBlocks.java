...
public final class BoneBlocks extends ModBlocks
{
	public static final BoneBlocks INSTANCE = new BoneBlocks();

	private BoneBlocks()
	{
		super("bone", BoneHitBoxes::new);
	}
	...
	private static final class BoneHitBoxes extends HitBoxes
	{
		@Override
