...
{
	private final Lazy<VoxelShape> bedDoubleShape = Lazy.of(this::bedDouble);
	private final Lazy<VoxelShape> bedSingleShape = Lazy.of(this::bedSingle);
	private final Lazy<VoxelShape> benchShape = Lazy.of(this::bench);
	private final Lazy<VoxelShape> bookshelfShape = Lazy.of(this::bookshelf);
	private final Lazy<VoxelShape> chairShape = Lazy.of(this::chair);
	private final Lazy<VoxelShape> chandelierShape = Lazy.of(this::chandelier);
	private final Lazy<VoxelShape> chestShape = Lazy.of(this::chest);
	private final Lazy<VoxelShape> cushionShape = Lazy.of(this::cushion);
	private final Lazy<VoxelShape> deskLeftShape = Lazy.of(this::deskLeft);
	private final Lazy<VoxelShape> deskRightShape = Lazy.of(this::deskRight);
	private final Lazy<VoxelShape> drawerShape = Lazy.of(this::drawer);
	private final Lazy<VoxelShape> dresserShape = Lazy.of(this::dresser);
	private final Lazy<VoxelShape> floorLightShape = Lazy.of(this::floorLight);
	private final Lazy<VoxelShape> lockboxShape = Lazy.of(this::lockbox);
	private final Lazy<VoxelShape> paintingSmallShape = Lazy.of(this::paintingSmall);
	private final Lazy<VoxelShape> paintingWideShape = Lazy.of(this::paintingWide);
	private final Lazy<VoxelShape> shelfShape = Lazy.of(this::shelf);
	private final Lazy<VoxelShape> shelfCenterShape = Lazy.of(this::shelfCenter);
	private final Lazy<VoxelShape> shelfLeftShape = Lazy.of(this::shelfLeft);
	private final Lazy<VoxelShape> shelfRightShape = Lazy.of(this::shelfRight);
	private final Lazy<VoxelShape> sofaShape = Lazy.of(this::sofa);
	private final Lazy<VoxelShape> sofaCenterShape = Lazy.of(this::sofaCenter);
	private final Lazy<VoxelShape> sofaLeftShape = Lazy.of(this::sofaLeft);
	private final Lazy<VoxelShape> sofaRightShape = Lazy.of(this::sofaRight);
	private final Lazy<VoxelShape> sofaCornerShape = Lazy.of(this::sofaCorner);
	private final Lazy<VoxelShape> stoolShape = Lazy.of(this::stool);
	private final Lazy<VoxelShape> tableLargeShape = Lazy.of(this::tableLarge);
	private final Lazy<VoxelShape> tableSmallShape = Lazy.of(this::tableSmall);
	private final Lazy<VoxelShape> tableWideShape = Lazy.of(this::tableWide);
	private final Lazy<VoxelShape> wallLightShape = Lazy.of(this::wallLight);
	private final Lazy<VoxelShape> wardrobeShape = Lazy.of(this::wardrobe);
	private final Lazy<VoxelShape> wardrobeTopperShape = Lazy.of(this::wardrobeTopper);
