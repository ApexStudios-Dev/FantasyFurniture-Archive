...
public interface VenthyrSet
{
    ...
    BlockEntry<SimpleMultiBlock.WithHorizontalFacing> TABLE_LARGE_FANCY = FurnitureSets.tableLargeFancy(NAME, () -> AllVoxelShapes.Venthyr.TABLE_LARGE).register();
    ...
    BlockEntry<SimpleHorizontalFacingBlock> TABLE_SMALL_FANCY = FurnitureSets.tableSmallFancy(NAME).hitbox(() -> AllVoxelShapes.Venthyr.TABLE_SMALL).register();
    ...
    BlockEntry<SimpleMultiBlock.WithHorizontalFacing> TABLE_WIDE_FANCY = FurnitureSets.tableWideFancy(NAME, () -> AllVoxelShapes.Venthyr.TABLE_WIDE).register();
    BlockEntry<SimpleSeatBlock.WithMultiBlock> BENCH = FurnitureSets.bench(NAME, () -> AllVoxelShapes.Venthyr.BENCH).register();
    BlockEntry<SimpleSeatBlock.WithMultiBlock.AtOriginOnly> CHAIR = FurnitureSets.chair(NAME, () -> AllVoxelShapes.Venthyr.CHAIR).register();
    BlockEntry<LightBlock> CHANDELIER = FurnitureSets.chandelier(NAME, () -> AllVoxelShapes.Venthyr.CHANDELIER).register();
    ...
    BlockEntry<OvenBlock> OVEN = FurnitureSets.oven(NAME, () -> AllVoxelShapes.Venthyr.OVEN).register();
